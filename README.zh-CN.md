...
> **Fork 说明。** 本仓库是 [YouTube Digest](https://github.com/zarazhangrui/youtube-digest)（作者 Zara Zhang）的 fork，遵循 MIT 协议。下面介绍的思维导图功能是本 fork 新增的。
...
![思维导图侧栏视图](mindmap-side-panel.png)

## v1.3.0 更新

- 把任意视频总结成一张覆盖全片的层级思维导图。
- 点击带时间戳的节点，视频会跳转到对应位置。
- 打开全屏大图查看，并可复制为 Markdown 大纲或导出 SVG。
- 导图文字与面板其他部分共用 Original、中文、双语设置。
...
> 请把这个项目下载或克隆到我选择的长期保留文件夹，告诉我准确的完整路径，并让 Chrome“加载已解压的扩展程序”使用同一个文件夹。如果我在第一次安装时需要位置建议，可以推荐 macOS 或 Linux 上的 `~/Documents/youtube-digest`，或 Windows 上的 `%USERPROFILE%\Documents\youtube-digest`，但不要假设我一定使用这些路径。请用简单易懂的语言一步一步指导我完成安装和配置。https://github.com/Hellenli624/youtube-digest-mindmap
...
1. 打开 [github.com/Hellenli624/youtube-digest-mindmap](https://github.com/Hellenli624/youtube-digest-mindmap)。
...
5. 选中字幕，获取 AI 内容讲解。
6. 打开 **Mind Map**，查看整个视频的层级总结，需要细看时点 **Full view** 打开全屏大图。
...
- 按需生成的思维导图，支持全屏查看、复制 Markdown 和导出 SVG。
