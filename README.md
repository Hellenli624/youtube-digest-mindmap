...
> **Fork notice.** This is a fork of [YouTube Digest](https://github.com/zarazhangrui/youtube-digest) by Zara Zhang, used under the MIT License. The mind map feature described below is an addition in this fork.
...
- See the whole video at a glance with a mind map, then open it as a full page.
...
<img src="mindmap-side-panel-en.png" alt="Mind Map tab in the side panel" width="900">

<img src="mindmap-full-page-en.png" alt="Full-page mind map with expand and collapse controls" width="900">

## New in v1.3.0

- Summarize any video as a mind map: a hierarchical tree that covers the whole video.
- Click a timestamped node to jump the video to that moment.
- Open the wide full-page view, copy the outline as Markdown, or export it as an SVG.
- Mind map labels follow the shared Original, Chinese, or bilingual setting.
...
1. Open [github.com/Hellenli624/youtube-digest-mindmap](https://github.com/Hellenli624/youtube-digest-mindmap).
...
6. Open **Mind Map** for a hierarchical summary, then use **Full view** for the wide version.
...
- A lazily generated mind map with a full-page view, Markdown copy, and SVG export.
