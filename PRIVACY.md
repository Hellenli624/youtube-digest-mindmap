...
- transcript plus relevant title, channel, description, or duration for an overview or a mind map;
...
- DeepSeek host access: provide AI overviews, explanations, translation, mind maps, and note polishing through DeepSeek V4 Flash.
